...
def parse_soccernet_splits(level):
    """Parse soccernet dataset into "train", "val", "test" splits.
    ...
    Returns:
        list: "train", "val", "test" splits of soccernet.
    """
    class_index_file = 'data/soccernet/annotations/classInd.txt'
    train_file_template = 'data/soccernet/annotations/trainlist.txt'
    val_file_template = 'data/soccernet/annotations/vallist.txt'
    test_file_template = 'data/soccernet/annotations/testlist.txt'
    ...
    for i in range(1, 2):
        ...
        with open(val_file_template.format(i), 'r') as fin:
            val_list = [line_to_map(x) for x in fin]
